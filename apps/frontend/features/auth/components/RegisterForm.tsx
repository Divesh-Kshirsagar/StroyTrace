  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        ...
        <CardDescription>Join Clarity today and start building your network.</CardDescription>
      </CardHeader>
        ...
        <CardContent className="flex flex-col gap-4">
          ...
          <FieldGroup>
            ...
            <Field data-invalid={!!errors.handle ? '' : undefined}>
              ...
              <Input placeholder="username" {...register('handle')} aria-invalid={!!errors.handle} />
              {errors.handle && <FieldDescription className="text-destructive">{errors.handle.message}</FieldDescription>}
            </Field>

            <Field data-invalid={!!errors.display_name ? '' : undefined}>
              <FieldLabel>Display Name</FieldLabel>
              <Input placeholder="Jane Doe" {...register('display_name')} aria-invalid={!!errors.display_name} />
              {errors.display_name && <FieldDescription className="text-destructive">{errors.display_name.message}</FieldDescription>}
            </Field>
          </FieldGroup>
        </CardContent>
