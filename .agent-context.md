...
- **SSR vs Client Fetching:** Server Components (`app/`) use direct `fetch` calls via generated SDK functions. Client Components (`features/`) use generated React Query hooks for fetching and mutations.
