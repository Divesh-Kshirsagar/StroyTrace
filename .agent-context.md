...
Phase 1: Foundation. Awaiting the exact Django model fields, JWT auth flow, and Next.js auth UI structure from the user to implement USER and CREATOR_PROFILE models.
