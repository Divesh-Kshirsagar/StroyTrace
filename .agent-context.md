...
Tasks 1.1–1.6 and 2.1–2.3 complete (feature/secure-evidence-upload):
...
Next: Task 2.4 — create migration for the two new Evidence fields. Branch: `feature/secure-evidence-upload`. Note: `pyvips` requires native `libvips` OS library — not present in dev env yet. 38/40 backend tests pass (2 fail due to missing migration — will be fixed by Task 2.4).
